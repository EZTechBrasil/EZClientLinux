...
typedef enum TClientType
{
	...
	DB_CLIENT_TYPE		= 0x04 , 
	XPERT_CLIENT_TYPE	= 0x08 ,
} TClientType ;

#define EZSERVER_LICENSE_MASK			0x01
#define EZHO_LICENSE_MASK				0x02
#define ZIGBEE_LICENSE_MASK				0x04
#define EZMONITOR_LICENSE_MASK			0x08
...
extern int DllInterface THose2Num( THose h ) ;
extern THose DllInterface Num2THose( int h ) ;
extern int DllInterface FormatToDecimals( TDisplayFormat f ) ;
extern int DllInterface FormatToWidth( TDisplayFormat f) ;
extern CCur DllInterface FormatToTolerance( TDisplayFormat f ) ;
...
#define SINK_DEFAULT_EVENTS  ( SINK_MINIMAL_PUMP_EVENT | SINK_DELIVERY_EVENT | SINK_DB_TANK_STATUS_EVENT | SINK_DB_HOSE_ETOTS_EVENT ) 
